...
**I'd say that it is somewhat interesting but may of the words you would think would be the highest are the highest, so it's not all that surprising.**
...
**I'd say it's more interesting since in shows the percent of words used, but there is no attention-grabbing graphic.**
...
**There seems to be a much larger amount of the use of words from the second table compared to the first one.**
...
**Task** Run the following code and describe the results. **"Health Occ" is much higher than any other two-word phrases for 2021.**
...
**Task** Run the following code and describe the results. **"Health Occ" still takes the cake is again is much higher than every other two-phrase word. Many of the phrases remain in the same spot as previously.**
...
**Task** Run the following code and describe the results. **"Summary suspension" goes 2nd highest and is relatively high compared to previous years, "Individual 4" is also a new entry that is at the 3rd spot.**
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Many of the sentiments are negative in both 2022 and 2023, the only complaint I have is that I feel like patient can be used in both a positive and negative sentiment depending on the context.**
