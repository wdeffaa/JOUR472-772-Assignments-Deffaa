...
**The columns now the show the date and the title of the press releases.**
...
**I would personally like to add a column that shows what state government individuals may be involved, or who put out the press release.**
...
tags. Describe the output: **This shows every bit of text that looks to be present on the website.**
...
**Task** Run the following code in the gray-colored codeblock below to make a dataframe. Describe the output: **What now shows is a more organized table format.**
...
**Task** Run the following code in the gray-colored codeblock below to remove the unwanted rows from our dataframe: **Now we removed all of the unnecessary items that have nothing to do with the press releases.**
