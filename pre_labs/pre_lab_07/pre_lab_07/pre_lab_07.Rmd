...
```{r echo=FALSE}
census_api_key("8cdd749de65edd30e3a9ec570b88d60131b24cdb", install=TRUE)
```
...
**Task** Run the following codeblock to find the Maryland county with the highest median household income and put the answer below. **Howard County, MD has the highest median household income.**
...
Is the difference between Calvert and Montgomery significant? **No, the differences are no statistically significant.**

Is the difference between Howard and everyone else significant? **Yes, the difference is statistically significant.**
...
**One question I would ask regarding the data would be: Throughout Baltimore, the school mix is very widely ranged in terms of enrollment, which of course does vary based on the median income of a certain part of Baltimore City, but is this a phenomenon with only Baltimore City or do other cities, in Maryland or even out-of-state have this same thing?**
...
**The results show that high schools that have immediate enrollment into college with 60% or more graduates, are shown to have a much higher average income in the area the school is in compared to high schools where less that 40% of graduating students immediately enroll into college.**
...
**Would simply moving the benchmark from 60/40% to 55/45% make that much of a difference in terms of what comes back for the average income?**
