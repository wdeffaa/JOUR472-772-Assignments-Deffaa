...
**Task** Run the following code. Describe the output in the space below. **The output shows a map of the state of Maryland with every Zip code shown.**
...
**Task** Run the following code. Describe the output in the space below. **Now you can see a slight outline of every Maryland county over the zip codes map.**
...
**Task** Run the following code. Describe the output in the space below. **This looks like data of people from every county and zip code from various places across the United States.**
...
**Task** Run the following code. Describe the output in the space below. **This dataset simply shows every county in Maryland, also showing GEOID.**
...
**Task** Run the following code. Describe the output in the space below. **This shows just a simple map of Maryland, with all of the counties outlines, with no zipcode outlines showing, while also dividing the Chesapeake Bay into its bordering counties.**
...
**Task** Run the following code. Describe the output in the space below. **This is the same as the map above, except now the zip code map is also added.**
...
**Task** Run the following code. Describe the output in the space below. **This dataset seems to be a list of the number of foreclosures by zipcode in Maryland, in March 2023.**
...
**Task** Run the following code. Describe the output in the space below. **This joins the zip codes and foreclosure datasets together.**
...
**Task** Run the following code. Describe the output in the space below. **This shows a color-coded map of the number of foreclosures in March of 2023 by zipcode in Maryland**
...
**This simply loads the different libraries we need.**
...
**Task** Run the following code. Describe the output in the space below. **This shows the number of foreclosures per-county in March of 2023, in Maryland.**
...
**Task** Run the following code. Describe the output in the space below. **This adds a geography column to help us later plot the counties.**
...
**Task** Run the following code. Describe the output in the space below. **This dataset just shows the number of foreclosures in every Maryland county in March of 2023.**
...
**Task** Run the following code. Describe the output in the space below. **This dataset shows the county population as well.**
...
**Task** Run the following code. Describe the output in the space below. **This shows coordinates so we can plot the map correctly to show the state of Maryland with county outlines.**
...
**Task** Run the following code. Describe the output in the space below. **This adds a column showing the rate of foreclosures per-1000 people in all Maryland counties in March 2023.**
...
**Task** Run the following code. Describe the output in the space below. **This shows a map of Maryland with a color-coded diagram showcasing all counties, with labels and outlines, that shows the foreclosure rate that was calculated previously.**
...
**Task** Run the following code. Describe the output in the space below. **This changes the color to a different scale than the previous, all-blue one.**
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **More rural counties have a lower foreclosure rate than more city-centered areas.**
