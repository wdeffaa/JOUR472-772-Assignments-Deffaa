...
**There are 24 rows and there should be 24 rows.**
...
**It contains information such as population who are over a certain age such as 18 and different races (mixed or one race).**
...
**Task** Using mutate, let's find the county with the highest 18+ Black population as a percentage of all population 18 and over and also the percentage of Democrats in that county. Put your answers below. **Prince George's County has the highest percentage of 18+ Black population AND the highest percentage of democrats in the state.**
...
**Task** Run the following code to load the Zip Code Tabulation Area data for Maryland. What's the datatype of the ZCTA5N column? **It looks like the datatype for the ZCTA5N column is zip codes, the same as the ZCTA5CE10 column.**
...
**Task** Run the following code to change the datatype of ZCTA5N from numeric to character. What's the datatype of ZCTA5N? **Personally, even after I ran the code multiple times I didn't see the datatype for ZCTA5N change at all.**
