...
```{r}
axolotr::ask(
  prompt = "When is the midterm for this class and how much is it worth in terms of our grade? What will the midterm contain, and how will it be completed?",
  model = "llama-3.1-8b-instant"
)
```

**Your comment: While the response wasn't completely correct and didn't really answer my question, I can understand how it may not have been able to due to a lack of evidence from the course. I believe that if I was able to give the syllabus and more course information, it would be able to answer my question.**
