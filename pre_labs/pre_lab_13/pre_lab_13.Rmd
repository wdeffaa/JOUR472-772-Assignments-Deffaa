...
**Task** Run the following code and describe the dataframe it outputs. **This dataframe shows every state and their GDP growth and population growth, as well as the president they voted for in 2020.**
...
**Task** Run the following code. Describe the plot. What pattern do you see? **I see a somewhat disorganized pattern of dots, with a line-of-best-fit, trending slightly upwards.**
...
**Task** Run the following code. Describe the plot. What do you see? **A slightly more organized scatter plot with a line-of-best-fit that is trending ever so slightly downwards, This scatterplot looks at GDP growth for every state.**
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **There seems to be not a whole lot of correlation of between the different variables.**
...
**Task** Run the following code. Describe the model output. What do you see? **It shows there to be not a significantly strong correlation.**
...
**Task** Run the following code. Describe the model output. What do you see? **I see a very weak correlation between these two variables.**
...
**Task** Run the following code. Describe the table. What do you see? **While the mean population growth was larger in states that voted Trump, mean gdp growth was larger under states that voted Biden.**
...
**Task** Run the following code. Describe the output. What do you see? **The mean seems to be higher in group Trump v. group Biden.**
...
**Task** Run the following code. Describe the output. What do you see? **The mean in group Biden is much higher than the mean in group Trump.**
